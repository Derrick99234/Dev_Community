...
const Hero = () => {
  return (
    <div className="w-full flex items-start justify-center flex-wrap md:items-center md:justify-between md:flex-nowrap gap-6 h-[90vh]">
      <div className="w-full flex items-start justify-center gap-4 md:gap-7 flex-col">
        ...
        <p>
          Great software that allows you to chat with anyone, anywhere, anytime
